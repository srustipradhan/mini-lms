    ...
    <GradientBackground>
      <SafeAreaView className="flex-1 px-4" edges={['top']}>
        <View className="mb-3 flex-row items-center gap-3">
          <Pressable accessibilityRole="button" onPress={() => router.back()} className="rounded-full bg-white/70 p-2 dark:bg-slate-800/70">
          ...
          <View className="flex-1">
            ...
            <Text className="text-sm text-slate-500 dark:text-slate-300">Lesson viewer</Text>
          </View>
        </View>
